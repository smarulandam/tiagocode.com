...
pub fn UnexpectedError() -> Element {
    rsx! {
        section { class: "rounded-2xl border border-red-200/80 bg-red-50/80 p-6 shadow-[0_20px_38px_-30px_rgba(17,28,42,0.28)] sm:p-7",
...
pub fn NotFoundError(route: Option<String>) -> Element {
    ...
    rsx! {
        section { class: "rounded-2xl border border-amber-200/80 bg-amber-50/80 p-6 shadow-[0_20px_38px_-30px_rgba(17,28,42,0.28)] sm:p-7",

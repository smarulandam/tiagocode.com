...
pub fn PrimaryTitle(text: String) -> Element {
    rsx! {
        h1 { class: "mb-2 font-display text-4xl font-semibold tracking-[-0.018em] text-[#087f8c]", "{text}" }
    }
}
...
pub fn SecondaryTitle(text: String) -> Element {
    rsx! {
        h2 { class: "mb-2 font-display text-4xl font-semibold tracking-[-0.018em] text-[#087f8c]", "{text}" }
    }
}
...
pub fn Decoration(text: String) -> Element {
    rsx! {
        span { class: "relative mb-5 pt-4 font-mono text-sm font-medium uppercase tracking-[0.12em] text-[#bb9f06] before:pr-2 before:content-['//']",
            "{text}"
        }
    }
}
...
pub fn Description(text: String) -> Element {
    rsx! {
        p { class: "max-w-[68ch] leading-[1.78] text-[#242424]", "{text}" }
    }
}

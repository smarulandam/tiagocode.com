...
pub fn PortfolioPage(lang: String) -> Element {
    ...
    rsx! {
        ...
        div { class: "justify-center lg:flex lg:space-x-8 lg:space-y-0 xl:space-x-12",
            aside { class: "top-2 hidden rounded-lg bg-primary px-4 py-3 shadow-[0_8px_26px_0_rgba(22,24,26,0.15)] transition ease-out duration-[160ms] hover:shadow-[0_10px_30px_0_rgba(22,24,26,0.22)] lg:sticky lg:top-[80px] lg:block lg:h-fit lg:w-1/4 lg:px-8 lg:py-5 xl:px-10 xl:py-7",
                Sidebar {}
            }

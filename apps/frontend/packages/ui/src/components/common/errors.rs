...
pub fn UnexpectedError() -> Element {
    rsx! {
        div { class: "flex flex-col items-center justify-center rounded-lg p-6 text-center text-gray-800 max-w-md mx-auto",
            svg {
            ...
            h2 { class: "text-2xl font-bold tracking-wide mt-4", "Oops! Something went wrong" }
            p {
            ...
            div { class: "flex gap-3 mt-4",
                a {
                    href: "/",
                    class: "px-5 py-2 bg-gray-300 text-gray-800 font-medium rounded-full shadow-md hover:bg-gray-400 transition duration-200",
                    "Go Home"
                }
            }
        }
...
pub fn NotFoundError(route: Option<String>) -> Element {
    rsx! {
        div { class: "flex flex-col items-center justify-center rounded-lg p-6 text-center text-gray-800 max-w-md mx-auto",
            ...
            h2 { class: "text-2xl font-bold tracking-wide mt-4", "Oops! Page Not Found" }
            p {
                class: "mt-2 text-gray-600",
                "The page you're looking for doesn't exist or has been moved."
            }
            if let Some(route) = route {
                p { class: "mt-2 text-sm text-gray-500", "Route: /{route}" }
            }
            div { class: "flex gap-3 mt-4",
                a {
                    href: "/",
                    class: "mt-4 px-5 py-2 bg-gray-800 text-white font-medium rounded-full shadow-md hover:bg-gray-700 transition duration-200",
                    "Go Home"
                }
            }
        }

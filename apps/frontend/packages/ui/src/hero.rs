...
pub fn Hero() -> Element {
    rsx! {
        section { class: "relative mx-auto w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200/70 bg-slate-950 p-7 text-slate-100 shadow-[0_24px_70px_-28px_rgba(15,23,42,0.6)] sm:p-10 lg:p-12",
            ...
            div { class: "relative grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]",
                div { class: "space-y-6",
                    p { class: "inline-flex rounded-full border border-sky-300/30 bg-sky-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-sky-200",
                        "Dioxus 0.7"
                    }
                ...
                div { class: "rounded-2xl border border-slate-700/80 bg-slate-900/60 p-5 shadow-inner",
                    img {

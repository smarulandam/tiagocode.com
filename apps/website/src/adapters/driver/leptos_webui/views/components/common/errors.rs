...
pub fn UnexpectedError() -> impl IntoView {
    view! {
        <div class="surface-panel status-card">
            <svg class="status-card__icon" xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 256 256" xml:space="preserve">
            ...
            <p>"An unexpected error occurred. Please try again later or go back to the homepage."</p>
...
pub fn NotFoundError() -> impl IntoView {
    view! {
        <div class="surface-panel status-card">
            ...
            <div class="status-card__actions">
                <button class="button-primary" onclick="window.location.href='/'">
                    Go Home
                </button>
            </div>
        </div>
